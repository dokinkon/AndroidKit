...
/**
 * Created by dokinkon on 2016/12/8.
 */
...
public class BitmapResizer {
    ...
    public BitmapResizer(Resources resources, int resId, int newWidth)
            throws IOException {
    ...
    public BitmapResizer(@NonNull File file, int newWidth) throws IOException {
        InputStream is = null;
        try {
    ...
    public BitmapResizer(@NonNull AssetManager manager, String assetName, int newWidth)
            throws IOException {
        InputStream is = null;
        try {
    ...
    private void roughScaleImage(InputStream is, @NonNull Size size) {
        Matrix matrix = new Matrix();
    ...
    private void roughScaleImage(Resources resources, int resId, @NonNull Size size) {
        Matrix matrix = new Matrix();
        matrix.postScale(size.scale, size.scale);
